...
//用户设备表分页
@WebServlet("/equipmentUserPage")
public class equipmentUserPage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 1; i <= pageNum; i++) {
            ...
            str = str.replace("#url", String.format("/smart_kitchens_war/equipmentUserPage?page=%d", i));
            if (page == i) {
                str = "&nbsp;&nbsp;&nbsp;" + i + "&nbsp;&nbsp;&nbsp;";
            }
            sb.append(str);
        ...
        request.getRequestDispatcher("equipmentUserPage.jsp").forward(request, response);
    }
}
