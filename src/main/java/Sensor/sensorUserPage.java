...
//用户传感器表分页
@WebServlet("/sensorUserPage")
public class sensorUserPage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 1; i <= pageNum; i++) {
            ...
            str = str.replace("#url", String.format("/smart_kitchens_war/sensorUserPage?page=%d", i));
            if (page == i) {
                str = "&nbsp;&nbsp;&nbsp;" + i + "&nbsp;&nbsp;&nbsp;";
            }
            sb.append(str);
        ...
        request.getRequestDispatcher("sensorUserPage.jsp").forward(request, response);
    }
}
