...
//管理员警告表分页
@WebServlet("/warnAdminPage")
public class warnAdminPage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        for (int i = 1; i <= pageNum; i++) {
            ...
            str = str.replace("#url", String.format("/smart_kitchens_war/warnAdminPage?page=%d", i));
            if (page == i) {
                str = "&nbsp;&nbsp;&nbsp;" + i + "&nbsp;&nbsp;&nbsp;";
            }
            sb.append(str);
        ...
        // 转发请求到userdata.jsp页面
        request.getRequestDispatcher("warnAdminPage.jsp").forward(request, response);
    }
}
