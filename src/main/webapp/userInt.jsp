...
<div class="container">
    ...
    <!-- 表单，使用onsubmit事件绑定handleSubmit函数 -->
    <form name="form1" method="post" action="userInt" onsubmit="handleSubmit()">
        <div class="title">请添加用户信息</div>
        <table>
            <tr>
                <td>用户名称:</td>
            ...
            <tr>
                <td>用户密码:</td>
                <td><input type="text" name="password" value="" class="txtBox" required /></td>
            </tr>
            <tr>
                <td>用户手机号:</td>
                <td><input type="text" name="phone" value="" class="txtBox" required /></td>
            </tr>
            <tr>
                <td>用户地址:</td>
                <td><input type="text" name="address" value="" class="txtBox" required /></td>
            </tr>
            <tr>
                <td>用户角色:</td>
                <td>
                    <select name="role" class="txtBox" required>
